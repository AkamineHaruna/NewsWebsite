...
<html lang="en">
  ...
  <head>
    ...
    <title>Tin Nhanh | Home Page</title>
...
<p>
          ...
          <b>Đăng bởi </b> <?php echo htmlentities($row['postedBy']);?> lúc </b><?php echo htmlentities($row['postingdate']);?> |
          <?php if($row['lastUpdatedBy']!=''):?>
          <b>Cập nhật bởi </b> <?php echo htmlentities($row['lastUpdatedBy']);?> lúc </b><?php echo htmlentities($row['UpdationDate']);?></p>
        <?php endif;?>
...
<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $currenturl;?>" target="_blank">Linkedin</a>  <b>Lượt xem:</b> <?php print $visits; ?>
                </p>
                <hr />
